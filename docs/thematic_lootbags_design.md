...
* *Лор:* Сверхзащищённый транспортный контейнер (ТК) из свинца и обеднённого урана для перевозки готовых твэлов, ТВС, микротвэлов и таблеток для всех типов реакторов NTM (РБМК, PWR, ZIRNOX, Ватц, исследовательские реакторы), а также радиоизотопных источников (РИТЭГ) и термоядерного горючего. Снабжён манипуляторными вольфрамовыми щипцами, дозиметром и радиопротекторами.
* **Содержимое:**
  ...
  * `hbm:item.plate_lead` (**Свинцовая защитная пластина**) | Кол-во: 2–4 | Вес: 50 | `RandomAmount="true"`. *Смысл:* Биологическая защита и футеровка пенала.
  ...
  * `hbm:item.radx` (**Рад-X**) | Кол-во: 1–2 | Вес: 45 | `RandomAmount="true"`. *Смысл:* Экстренный радиопротектор оператора.
  * `hbm:item.rbmk_pellet_ueu` (**Топливная таблетка РБМК (UEU)**) | Кол-во: 2–4 | Вес: 50 | `RandomAmount="true"`. *Смысл:* Таблетка природного/обеднённого урана.
  * `hbm:item.rbmk_pellet_meu` (**Топливная таблетка РБМК (MEU)**) | Кол-во: 2–4 | Вес: 45 | `RandomAmount="true"`. *Смысл:* Таблетка среднеобогащённого урана.
  * `hbm:item.rbmk_pellet_thmeu` (**Топливная таблетка РБМК (Th-MEU)**) | Кол-во: 2–4 | Вес: 40 | `RandomAmount="true"`. *Смысл:* Ториево-урановая топливная таблетка.
  * `hbm:item.rbmk_pellet_heu235` (**Топливная таблетка РБМК (HEU-235)**) | Кол-во: 2–4 | Вес: 30 | `RandomAmount="true"`. *Смысл:* Таблетка высокообогащённого урана-235.
  * `hbm:item.rbmk_pellet_mox` (**Топливная таблетка РБМК (MOX)**) | Кол-во: 2–4 | Вес: 30 | `RandomAmount="true"`. *Смысл:* Смешанное уран-плутониевое оксидное топливо.
  * `hbm:item.rbmk_pellet_lep` (**Топливная таблетка РБМК (LEP)**) | Кол-во: 2–4 | Вес: 25 | `RandomAmount="true"`. *Смысл:* Низкообогащённое плутониевое топливо.
  * `hbm:item.rbmk_pellet_hecm` (**Топливная таблетка РБМК (HECm)**) | Кол-во: 1–2 | Вес: 15 | `RandomAmount="true"`. *Смысл:* Высокообогащённое кюриевое топливо.
  ...
  * `hbm:item.rbmk_fuel_ueu` (**ТВС РБМК (UEU)**) | Кол-во: 1 | Вес: 35 | `RandomAmount="false"`. *Смысл:* Базовая сборка обеднённого/природного урана.
  * `hbm:item.rbmk_fuel_meu` (**ТВС РБМК (MEU)**) | Кол-во: 1 | Вес: 30 | `RandomAmount="false"`. *Смысл:* Готовая кассета среднеобогащённого урана.
  ...
  * `hbm:item.rbmk_fuel_hep239` (**ТВС РБМК (HEP-239)**) | Кол-во: 1 | Вес: 15 | `LimitedDropCount="1"` | `RandomAmount="false"`. Высокообогащённая плутониевая ТВС.
  ...
  * `hbm:item.rod_zirnox:0` (**Циркониевый стержень ZIRNOX (Природный уран)**) | Кол-во: 1 | Вес: 45 | `RandomAmount="false"`. *Смысл:* Базовое топливо реактора ZIRNOX.
  * `hbm:item.rod_zirnox:1` (**Циркониевый стержень ZIRNOX (Обогащённый уран)**) | Кол-во: 1 | Вес: 35 | `RandomAmount="false"`. *Смысл:* Урановый стержень ZIRNOX.
  * `hbm:item.rod_zirnox:3` (**Циркониевый стержень ZIRNOX (Торий)**) | Кол-во: 1 | Вес: 30 | `RandomAmount="false"`. *Смысл:* Ториевый воспроизводящий стержень.
  ...
  * `hbm:item.watz_pellet:5` (**Топливная микросфера Ватц (MEU)**) | Кол-во: 2–4 | Вес: 40 | `RandomAmount="true"`. *Смысл:* Базовый микротвэл урана реактора Ватц.
  * `hbm:item.watz_pellet:8` (**Поглощающая микросфера Ватц (Бор)**) | Кол-во: 1–2 | Вес: 35 | `RandomAmount="true"`. *Смысл:* Борный замедлитель/поглотитель.
  * `hbm:item.watz_pellet:9` (**Воспроизводящая микросфера Ватц (DU)**) | Кол-во: 1–2 | Вес: 35 | `RandomAmount="true"`. *Смысл:* Обеднённый уран для бридинга плутония.
  * `hbm:item.watz_pellet:6` (**Топливная микросфера Ватц (MEP)**) | Кол-во: 1–2 | Вес: 25 | `RandomAmount="true"`. *Смысл:* Плутониевый микротвэл Ватц.
  * `hbm:item.watz_pellet:14` (**Топливная микросфера Ватц (AMF)**) | Кол-во: 1 | Вес: 15 | `LimitedDropCount="1"` | `RandomAmount="false"`. Америциевый микротвэл Ватц.
  * `hbm:item.watz_pellet:16` (**Топливная микросфера Ватц (CMF)**) | Кол-во: 1 | Вес: 10 | `LimitedDropCount="1"` | `RandomAmount="false"`. Кюриевый микротвэл Ватц.
  * `hbm:item.watz_pellet:17` (**Топливная микросфера Ватц (Берклий-247)**) | Кол-во: 1 | Вес: 5 | `LimitedDropCount="1"` | `RandomAmount="false"`. Редкий берклиевый микротвэл.
  ...
  * `hbm:item.rod:14` (**Урановый стержень (Классический)**) | Кол-во: 1 | Вес: 40 | `RandomAmount="false"`. *Смысл:* Топливо исследовательского реактора.
  * `hbm:item.rod:8` (**Стержень из урана-238**) | Кол-во: 1–2 | Вес: 40 | `RandomAmount="true"`. *Смысл:* Воспроизводящий стержень для облучения нейтронами.
  * `hbm:item.rod:4` (**Стержень из тория-232**) | Кол-во: 1 | Вес: 30 | `RandomAmount="false"`. *Смысл:* Бридинг урана-233.
  ...
  * `hbm:item.rod:0` (**Литиевый стержень**) | Кол-во: 1–2 | Вес: 30 | `RandomAmount="true"`. *Смысл:* Наработка трития при нейтронном облучении.
  * `hbm:item.rod:2` (**Кобальтовый стержень**) | Кол-во: 1–2 | Вес: 25 | `RandomAmount="true"`. *Смысл:* Наработка радиоактивного кобальта-60.
  ...
  * `hbm:item.cell_deuterium` (**Пробирка с дейтерием**) | Кол-во: 1–2 | Вес: 35 | `RandomAmount="true"`. *Смысл:* Изотоп для реакций термоядерного синтеза.
  * `hbm:item.cell_tritium` (**Пробирка с тритием**) | Кол-во: 1–2 | Вес: 35 | `RandomAmount="true"`. *Смысл:* Тритиевый компонент дейтерий-тритиевой плазмы.
  * `hbm:item.icf_pellet` (**Мишень термоядерного синтеза (ICF Pellet)**) | Кол-во: 1–2 | Вес: 20 | `RandomAmount="true"`. *Смысл:* Мишень для лазерного термоядерного поджига.
...
| **311** | Транспортный пенал ядерного топлива | 3 | 3 | 1–3 | false | 63 |
