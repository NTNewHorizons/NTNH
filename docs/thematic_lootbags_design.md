...
| **`POOL_SPACESHIP`** | Разбившийся звездолёт | НАЗ (310) [4], Пенал изотопов (311) [4], Бортовой ремнабор (312) [4] | 12 / 67 | **17.91%** | **79.4%** | **1.43** |
...
| **ИТОГО** | **33 группы** | — | — | — | — | **939 позиций** (951 в XML с 6 дефолтными группами) |
